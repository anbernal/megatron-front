...
import { cilList, cilShieldAlt,cibCircle,cibCircleci,cilXCircle,cilChartLine } from '@coreui/icons';
...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  icons = { cilList, cilShieldAlt,cibCircle,cibCircleci,cilXCircle,cilChartLine};
